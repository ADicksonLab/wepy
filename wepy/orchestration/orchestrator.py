...
class NewOrchestrator():
    ...
    def __init__(self, orch_path=":memory:",
        ...
        # create a new table in the database with the columns
        dbconn = sqlite3.connect(self.orch_path)
        ...
        """
        dbconn.cursor().execute(create_run_table_query)


        # then set the data if it is given
    ...
    def set_default_configuration(self, configuration):
        ...
        with self.metadata_kv.lock():
            self.metadata_kv['default_configuration'] = serial_config
    ...
    def get_default_configuration(self):
        ...
        return self.deserialize(self.metadata_kv['default_configuration'])
