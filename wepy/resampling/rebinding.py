...
class WExplore2Resampler(Resampler):
    ...
    def __init__(self, seed=None, pmin=1e-12, pmax=0.1, dpower=4, merge_dist=0.25,
        ...
        if distance_function == 'unbinding':
            self.distance_function = OpenMMUnbindingDistance(self.topology,
                                                             self.ligand_idxs, self.binding_site_idxs, alternative_maps)
        elif distance_function == 'rebinding':
            self.distance_function = OpenMMRebindingDistance(self.topology,
                                                             self.ligand_idxs, self.binding_site_idxs, alternative_maps, comp_xyz)
        else:
