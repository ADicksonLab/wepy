...
def main(runtime, steps, n_walkers, n_workers=1, debug_prints=False, seed=None):
    ...
    ### RUN the simulation
    print("Starting run")
    sim_manager.run_simulation_by_time(runtime, steps, debug_prints=True)
    print("Finished run")
...
if __name__ == "__main__":
    ...
    if sys.argv[1] == "--help" or sys.argv[1] == '-h':
        print("arguments: runtime, n_steps, n_walkers, n_workers")
    else:
        ...
        print("Number of steps per cycle: {}".format(n_steps))

        start = time.time()
        main(runtime, n_steps, n_walkers, n_workers, debug_prints=True)
        end = time.time()
