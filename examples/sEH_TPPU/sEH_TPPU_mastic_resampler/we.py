...
if __name__ == "__main__":
    ...
    # load system type for mastic profiling
    system_pkl_path = '../sEH_TPPU_SystemType.pkl'
    ...
    # set up mastic distance function
    ...
    resampler = WExplore2Resampler(distance_function=hbond_distance,
                                   merge_dist=0.5,
