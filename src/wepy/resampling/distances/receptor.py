...
class ReceptorDistance(Distance):
    ...
    def __init__(self, ligand_idxs, binding_site_idxs, ref_state):
        ...
        self._image_bs_idxs = np.arange(
            self._n_lig_atoms, self._n_lig_atoms + self._n_bs_atoms
        )
    ...
    def _unaligned_image(self, state):
        ...
        grouped_positions = group_pair(
            state["positions"], box_lengths, self._bs_idxs, self._lig_idxs
        )
    ...
    def image(self, state):
        ...
        sup_image, _, _ = superimpose(
            self.ref_image, state_image, idxs=self._image_bs_idxs
        )
