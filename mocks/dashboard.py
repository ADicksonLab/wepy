...
step_time = 2e-15 # seconds / 2 femtoseconds
reporter = WExploreDashboardReporter('wepy.dash.txt', step_time=step_time)

reporter.init()


reporter.report(0, init_walkers, warp_data, bc_data, progress_data,
                resampling_data, resampler_data, n_steps=10000)
