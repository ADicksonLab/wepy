...
with start_action(action_type="Setup") as setup_cx:
    ...
    ## Application Imports
    with start_action(action_type="Parameters"):
    ...
    ## Boundary Conditions
    with start_action(action_type="Instantiate BC") as cx:
    ...
    ## Reporters
    with start_action(action_type="Instantiate Reporters") as cx:
    ...
    with start_action(action_type="Instantiate Work Mapper") as cx:
