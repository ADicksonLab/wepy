...
class TestCombinationsMinorNode:
    ...
    def test_combinations(
        ...
        config = sim_maker.make_configuration(
            apparatus, work_mapper=work_mapper, platform=platform, reporters=None
        )
...
class TestCombinationsDevNode:
    ...
    def test_combinations(
        ...
        config = sim_maker.make_configuration(
            apparatus, work_mapper="TaskMapper", platform=platform, reporters=None
        )
...
class TestCombinationsBigNode:
    ...
    def test_combinations(
        ...
        config = sim_maker.make_configuration(
            work_mapper="TaskMapper", platform=platform
        )
